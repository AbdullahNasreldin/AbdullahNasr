        ...
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				include_once('staff.php');
														$ses = new staff;
	  $ff = $ses ->RUNSearch("select  * from staff where (staff_username = '".$_SESSION['stf']."' OR
	 staff_email = '".$_SESSION['stf']."'
	 OR
	 staff_phone = '".$_SESSION['stf']."'
	 )
	 ");
								   
								   if($rows = mysqli_fetch_assoc($ff)){
   
	  $_SESSION['stfs'] = $rows['staff_username'];
	   ?>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                         ...
                         <li>
                            <a href="tochat.php"><i class="fa fa-dashboard fa-fw nav_icon"></i>My chat</a>
                        </li>
                        <li>
