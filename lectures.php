	...
	<div class="stats-bottom contact">
		<div class="container">
            ...
            <?php 
						...
						$ses = new lectures;
	  $ff = $ses ->RUNSearch("select  * from lectures where courses_name = '".$_GET['courses_name']."' ");
				...
				<div class="col-md-8 agileinfo_services_grid">
					...
					<div class="agileinfo_services_grid1">
						...
						<h4><?php echo $rows['lecture_subject']; ?></h4>
                        <iframe width="500" height="500"
					src="<?php echo $rows['lecture_link']; ?>" frameborder="0" allowfullscreen>
					</iframe>
               			 </div>
               			 </div>
                 <br><br><br>
