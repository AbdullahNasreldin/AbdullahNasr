																	...
																	<h3 class="agileinfo_sign">Registrate</h3>	
																			<div class="login-form" id="v" >
																				<form  method="post">	
																				    ...
																				    <span id = "av"></span>
																					<input type="text" name="studentusername" placeholder="username" required>
																					<input type="password" name="studentpassword" placeholder="Password" id="ehab1" required>
																					<input type="password" name="password" placeholder="Confirm Password" id="ehab2" required>
                                                                                   <span id="ehab3"> </span>
																					...
																					<input type="number" name="studentphone" placeholder="your Phone Number" required>
																                  <P>YOUR year</P>
																					<select  name="year" >
                                                                                    					<?php
